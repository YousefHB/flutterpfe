...
Future<void> deletePost(String postId , void Function() refreshPosts) async {
  ...
  final headers = {
    'Content-Type': 'application/json',
    'Authorization': 'Bearer $accessToken', // Assurez-vous de passer le jeton d'accès correctement
  };
...
Future<void> updatePost(String postId, String newContent , void Function() refreshPosts) async {
  try {
  ...
  builder: (context) {
    return AlertDialog(
      ...
      actions: <Widget>[
        ...
        ElevatedButton(
          onPressed: () {
            updatePost(widget.postid,contentController.text , widget.onDelete );
            Navigator.of(context).pop();
          },
          child: Text(
            'Enregistrer',
